...
const AdminDashboard = () => {
    ...
    const fetchUsers = () => {
        fetch('https://f1-manager-api.onrender.com/api/v1/auth/users', {
    ...
    useEffect(() => {
        fetch('https://f1-manager-api.onrender.com/api/v1/teams')
            .then(res => res.json())
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await fetch(`https://f1-manager-api.onrender.com/api/v1/auth/users/${id}`, {
                method: 'DELETE',
                headers: { 'Authorization': `Bearer ${auth.token}` }
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = editingId
                ? `https://f1-manager-api.onrender.com/api/v1/auth/users/${editingId}`
                : 'https://f1-manager-api.onrender.com/api/v1/auth/signup';
